/**
 * ******************************************************************************
 ** Form generated from reading ui file 'frmIncial.jui' * * Created by: Qt User
...
public class frmInicial implements com.trolltech.qt.QUiForm<QMainWindow> {
    ...
    //Método usado para abrir el formulario de registro de entrenamientos
    public void abrir() {
        frmEntrena entrena = new frmEntrena();
        QDialog dialogo = new QDialog();
        entrena.setupUi(dialogo);
        // Asignamos que la ventana de registro sea modal
    ...
    public void setupUi(QMainWindow MainWindow) {
        ...
        logo_lateral.setPixmap(new QPixmap(("classpath:resources/img_logo.png")));
        ...
        btnEntrenamiento.clicked.connect(this, "abrir()");
