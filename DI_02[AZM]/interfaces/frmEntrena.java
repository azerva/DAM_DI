/********************************************************************************
 ** Form generated from reading ui file 'frmEntrena.jui'
 **
...
public class frmEntrena implements com.trolltech.qt.QUiForm<QDialog>
{
    ...
    public void setupUi(QDialog Dialog)
    {
        ...
        logoApp.setPixmap(new QPixmap(("resources/img_logo.png")));
        ...
        logoRegistro.setPixmap(new QPixmap(("resources/img_logo2.png")));
        ...
        txtFecha.setGeometry(new QRect(300, 270, 126, 40));
        ...
        dateEdit.setGeometry(new QRect(440, 270, 141, 40));
        ...
        btnSalir.setIcon(new QIcon(new QPixmap("resources/salir.png")));
        ...
        btnSave.setIcon(new QIcon(new QPixmap("resources/guardar.png")));
        ...
        btnClean.setIcon(new QIcon(new QPixmap("resources/clean.png")));
